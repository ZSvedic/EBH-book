...
@REM Build HTML:
pandoc -s %front% %content% -o ../output/EBH.html --toc -c ../styling/html-epub-styling.css --lua-filter=../styling/pagebreak.lua --lua-filter=../styling/html-open-links-in-new-tab.lua

@REM Build EPUB:
pandoc -s %front% %content% -o ../output/EBH.epub --toc -c ../styling/html-epub-styling.css --lua-filter=../styling/pagebreak.lua 
